...
class MembersHttpHandlerTest {
     ...
     * This will allow to test the server but the cost is that the server will be started and stopped for each test
     *
     * @throws IOException
     */
    @BeforeEach
    ...
    private static void testGetAMemberById(int studentNumber, String expectedName) throws IOException, InterruptedException {
        //Build the request
        var client = HttpClient.newHttpClient();
        ...
        Etudiant e = JaxsonUtils.fromJson(json, Etudiant.class);
    }
